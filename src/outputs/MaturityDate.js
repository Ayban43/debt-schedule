...
const MaturityDate = () => {
    ...
    function amortizationSchedule(loanAmount, annualInterestRate, numPayments, interestFrequency, paymentFrequency) {
        ...
        for (var i = 0; i < period; i++) {
            ...
            var currentBalance = (i === 0) ? loanAmount : schedule[i - 1].remainingBalance;
            var paymentDate
            schedule.push({
                [periodLabel]: i + 1,
                interest: interest,
    ...
    let schedule = amortizationSchedule(beginningBalance, interest / 100, getNoOfMonths(), interestFrequency, paymentFrequency)
